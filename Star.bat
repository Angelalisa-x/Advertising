cd WhiteList
F:/python3.7/python.exe e:/work/Advertising/WhiteList/WhiteList.py

cd ..
cd xiugaiWhite
F:/python3.7/python.exe e:/work/Advertising/xiugaiWhite/xiugai.py
...
cd ..
cd Adguard
F:/python3.7/python.exe e:/work/Advertising/Adguard/Adguard_Ex.py
...
del E:\work\Advertising\xiugaiWhite\Adguard_Ex.py /q /f /s
